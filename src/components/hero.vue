<template>
  <div>
    <section class="bg-white dark:bg-gray-900">
      <div
        class="py-6 px-4 mx-auto max-w-screen-xl text-center lg:py-20 lg:px-12"
      >
        <img
          class="rounded-full w-1/2 h-1/2 mx-auto my-14 dark:bg-gray-900 sm:w-96 sm:h-96"
          src="../assets/img/worm.jpg"
        ...
        >
          Phone :<span
            class="text-gray-500 dark:text-white px-2 mx-2 underline"
          >
            0993629190</span
          >
          | Email :
          <span class="underline text-gray-500 dark:text-white px-2 mx-2"
            >wormkung99@gmail.com</span
          >
        </p>
        <p
        ...
        <a href="https://github.com/wormkung" target="_blank">
          <button
            type="button"
